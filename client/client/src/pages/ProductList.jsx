    ...
    <Container>
      ...
      <FilterContainer>
        <Filter>
          ...
          <Select name="seasonal" onChange={handleFilters}>
            <Option disabled >Seasonal</Option>
            <Option>winter </Option>
            <Option>summer</Option>
            <Option>all Seasoned </Option>
            <Option>vest Sellers</Option>
          ...
          <Select name="flowers" onChange={handleFilters}>
            <Option disabled>Flowers </Option>
            <Option>Ranuculus</Option>
            <Option>Ixia</Option>
            <Option>Tritonia </Option>
            <Option>Sparaxis</Option>
            <Option>Hedychium (Ginger Lily) Griffithianum</Option>
            <Option>NM- candytuff- Iberis Amara White</Option>
